 ...
 */
extern unsigned short kbdmo_get_scancode(void);
 ...
 */
extern unsigned char kbdmo_getc(void);

/*
 * Use polling to fetch a key
 */
extern char kbdmo_getc_poll(void);

/*
 * Use polling to fetch a scan code
 */
extern unsigned short kbdmo_get_scancode_poll(void);

extern void kbdmo_handle_irq(void);
